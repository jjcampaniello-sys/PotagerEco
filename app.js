...
const catalogueInitial = [
    ...
    { 
        ...
        descriptionRole: "Exigeante en chaleur. S'associe bien avec les haricots."
    },
    { 
        ...
        descriptionRole: "Aime la proximité des aromates comme le basilic."
    },
    // --- LÉGUMES-FEUILLES ---
    { 
    ...
    { 
        ...
        descriptionRole: "Ses racines sécrètent des saponines bénéfiques au sol."
    },
    { 
        ...
        descriptionRole: "Très productive. S'accorde avec les carottes et les haricots."
    },
    { 
        ...
        descriptionRole: "Rustique. Apprécie la compagnie des plantes aromatiques."
    },
    // --- LÉGUMES-RACINES ---
    { 
        ...
        descriptionRole: "Sensible à la mouche de la carotte. Protégée par les oignons."
    },
    { 
        ...
        descriptionRole: "Intercalaire idéal. Se récolte très rapidement."
    },
    { 
    ...
    { 
        ...
        semis: "Février - Avril", repiquage: "Mars - Avril", moisMiseEnTerre: 2, moisMax: 3, joursMaturation: 110, distanceMin: 10,
        descriptionRole: "Répulsif naturel pour la mouche de la carotte."
    },
    // --- LÉGUMINEUSES ---
    { 
    ...
    { 
        ...
        descriptionRole: "Enrichit la terre en azote. Préfère les climats frais."
    },
    { 
        ...
        descriptionRole: "Excellente plante de début de saison. Attire les pucerons."
    },
    // --- PLANTES AROMATIQUES ---
    { 
    ...
    { 
        ...
        descriptionRole: "Apprécie l'ombre tamisée des tomates et poivrons."
    },
    { 
        ...
        descriptionRole: "Vivace. Aide à repousser les pucerons et l'oïdium."
    },
    // --- FLEURS BÉNÉFIQUES ---
    { 
    ...
    { 
        ...
        descriptionRole: "🛡️ Attire les syrphes et nettoie le sol des parasites."
    },
    { 
        ...
        descriptionRole: "🐛 Fleur sacrifice : elle attire les pucerons noirs."
    }
];
...
const MATRICE_ASSOCIATIONS = {
    tomate: {
        ...
        basilic: { type: "COMPAGNONNAGE_DIRECT", distance: "15-20 cm", conseil: "🚀 Le basilic stimule la pousse de la tomate, améliore sa saveur et éloigne le mildiou." },
        haricot_vert: { type: "COMPAGNONNAGE_DIRECT", distance: "20-25 cm", conseil: "🌿 Le haricot fixe l'azote de l'air pour fertiliser le pied de tomate." },
    ...
    courgettes: {
        ...
        haricot_vert: { type: "COMPAGNONNAGE_DIRECT", distance: "25-30 cm", conseil: "🌿 Le haricot enrichit le sol en azote, profitant au feuillage gourmand de la courgette." },
    ...
    haricot_vert: {
        tomate: { type: "COMPAGNONNAGE_DIRECT", distance: "20-25 cm", conseil: "🌿 Le haricot fournit de l'azote naturel utilisable par la tomate." },
        courgettes: { type: "COMPAGNONNAGE_DIRECT", distance: "25-30 cm", conseil: "🌿 Synergie idéale : enrichit la terre en azote pour la courgette." },
        carotte: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🤝 Association classique du potager : la carotte profite de l'azote du haricot." },
        laitue: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🥬 La laitue s'épanouit au pied des haricots sans gêner leurs racines." }
    },
    laitue: {
        carotte: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🤝 Les racines superficielles de la salade ne gênent pas le développement bulbeux de la carotte." },
        haricot_vert: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🥬 Profite de l'azote fixé par les fabacées et de leur ombre légère." },
        tomate: { type: "COMPAGNONNAGE_DIRECT", distance: "15-20 cm", conseil: "⛱️ Profite de l'ombrage tamisé du feuillage de la tomate pendant les chaudes journées." }
    },
    carotte: {
        ...
        laitue: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🤝 Bon gain d'espace : récolte rapide de la laitue libérant l'espace pour la carotte." },
        haricot_vert: { type: "COMPAGNONNAGE_DIRECT", distance: "10-15 cm", conseil: "🌿 Bénéficie de la fertilisation azotée naturelle apportée par le haricot." }
    },
    basilic: {
        tomate: { type: "COMPAGNONNAGE_DIRECT", distance: "15-20 cm", conseil: "🚀 Alliance phare du potager : amélioration gustative et répulsif anti-moustiques/mouches." },
        courgettes: { type: "PROTECTION_SANITAIRE", distance: "15-20 cm", conseil: "🛡️ Son parfum fort masque les plantes et repousse certains nuisibles." }
    },
    oeillet_inde: {
...
// Taille par défaut (en cm) attribuée à une case vide de la grille (ajustée à 20)
const TAILLE_CASE_PAR_DEFAUT_CM = 20;
// =================================================================
...
async function chargerMeteoEtAlertes() {
    ...
    const apiUrl = `https://open-meteo.com{latitude}&longitude=${longitude}&daily=temperature_2m_max,temperature_2m_min,precipitation_sum,windspeed_10m_max&timezone=auto`;
    try {
